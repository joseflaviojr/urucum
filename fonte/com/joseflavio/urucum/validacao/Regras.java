...
/**
 * Validação de {@link Field} conforme as regras de outro {@link Field}.<br>
 * {@link Nome} e {@link Escopo} não são importados.
...
public @interface Regras {
	...
	/**
	 * {@link Class} que contém o {@link Field} desejado.
