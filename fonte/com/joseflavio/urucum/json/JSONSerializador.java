 ...
 */
public class JSONSerializador extends StdSerializer<JSON> {
	...
	public JSONSerializador( Class<JSON> t ) {
		super( t );
	}
	...
	public JSONSerializador( StdSerializer<JSON> src ) {
		super( src );
	}

	public JSONSerializador( Class<JSON> t, boolean dummy ) {
		super( t, dummy );
	}
