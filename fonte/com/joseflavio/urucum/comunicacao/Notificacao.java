...
/**
 * Notificação sobre mudança de estado de objeto.
 * @author José Flávio de Souza Dias Júnior
 */
public interface Notificacao<OBJETO,ESTADO> {
	
	/**
	 * @param objeto Objeto que mudou de estado.
	 * @param estado Novo estado do objeto.
	 */
	void notificar( OBJETO objeto, ESTADO estado );
